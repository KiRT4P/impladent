...
export default function UserMonth({ data }) {
    ...
    return (
        <div className=" mb-16 relative">
            <div className="absolute size-52 rounded-full blur-3xl -z-50 top-32 -right-5 bg-primary/50"></div>
            <div className="absolute size-52 rounded-full blur-3xl -z-50 bottom-0 -left-5 bg-primary/50"></div>
            ...
            <div className="flex justify-between mt-4">
                <Link href={"/monthly/" + thisMonth.id} className="w-[49%] relative flex flex-col justify-end rounded-lg overflow-hidden">
                    ...
                    <div className="z-50 text-white p-8">
                ...
                <div className="w-[49%]">
                    {data.filter((_, i) => i > 0).map((c) => (
                        <Link key={c.id} href={"/monthly/" + c.id} className="flex mb-2  w-full items-center" >
