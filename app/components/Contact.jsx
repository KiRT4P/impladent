    ...
    return (
        <div>
            ...
            <div className='flex justify-center items-center my-8'>
                <h1 onClick={e => setCity(true)} className={` text-5xl font-bold text-center cursor-pointer ${city ? "text-primary" : "text-gray-300"}`}>Košice</h1>
                <div className='w-[2px] h-8 bg-gray-300 mx-12'></div>
                <h1 onClick={e => setCity(false)} className={` text-5xl font-bold text-center cursor-pointer ${city ? "text-gray-300 " : "text-primary"}`}>Michalovce</h1>
            </div>
