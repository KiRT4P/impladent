    ...
    return (
        <div className="relative h-52">
            <div className="absolute flex justify-center  w-full">
                <div className="bg-white shadow-xl md:w-[70%] rounded-xl p-4 md:p-8 mx-4 md:mx-0">
                    ...
                    <div className="border-2 border-primary rounded-2xl float-right hover:bg-primary hover:text-white duration-300 cursor-pointer px-8 py-2 text-primary w-min uppercase text-lg">Odoslať</div>
